...
export const GlareCard = ({
   ...
   return (
      <div
         ...
         className='relative isolate [contain:layout_style] [perspective:700px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[600px] [aspect-ratio:16/10]'
         ref={refElement}
         onPointerMove={(event) => {
